...
def generate_html(data):
    ...
    dashboard_password = os.environ.get("DASHBOARD_PASSWORD", "secret123")
    ...
    <body>
        ...
        <div id="login-screen">
            <div id="login-box">
                <h2>🔐 アクセス制限</h2>
                <p>合言葉を入力してください</p>
                <input type="password" id="pw-input" placeholder="合言葉">
                <br>
                <button onclick="checkPw()">表示する</button>
                <p id="pw-error" style="color:red; display:none; margin-top:10px;">合言葉が違います</p>
            </div>
        </div>
    ...
    html += f"""
        ...
        <script>
            ...
            const secret = "{dashboard_password}";
            ...
            if (sessionStorage.getItem("pharmaAuth") === "true") {{
                document.getElementById("login-screen").style.display = "none";
                document.getElementById("app-content").style.display = "block";
            }}
        </script>

...
def generate_html(data):
            ...
            rows += f"""
                    <tr>
                        ...
                        <td>
                            ...
                            {f'<div style="font-size:0.8rem; margin-top:4px;">受付: {item.get("date")}</div>' if item.get('date') else ''}
                        </td>
                        <td>
    ...
    def get_medipal_rows(items):
        ...
        for item in items:
            ...
            status_class = "status-danger" if is_danger else ""
            ...
            rows += f"""
                    <tr>
                        ...
                        <td>
                            ...
                            <div style="font-size:0.8rem; margin-top:4px;">更新: {item.get('date', '')}</div>
                        </td>
                        <td>
...
<head>
    ...
    <style>
        :root {{
            --primary: #1976D2; /* Medipal blue */
            --secondary: #00897B; /* ALF green */
            --tertiary: #5E35B1; /* Collabo purple */
            --bg: #f4f6f8;
            --surface: #ffffff;
            --text: #333333;
    ...
    <div class="container">
        ...
        <div class="card">
            ...
            <div class="table-container">
                <table><thead><tr><th>品名/メーカー</th><th>状況/納期</th><th>数量</th></tr></thead><tbody>
